...
public class BotWithAPlot : BotTemplate
{
	public BotWithAPlot(int botColor)
	{
		color = botColor;
		pieces = new List<Piece>();
		name = "Bot With a Plot";
		choosePieces();
	}

	NextMove bestNextMove = null;
    bool isMovePreloaded = false;
	...
	{
		if (isMovePreloaded == false)
		{
            float bestMoveDiff = -1000;
            List<NextMove> validMoves = new List<NextMove>();
            List<NextMove> allMoves = getAllPossibleBotMovesAndAbilities(this, this.currentBoardState, this.color);
            NextMove bestResponseToOppBestResponse = null;
            ...
            foreach (NextMove nextMove in allMoves)
            {
                ...
                NextMove bestResponseToOppBestMove = null;
                ...
                foreach (NextMove nextMoveOpp in allMovesOpp)
                {
                    ...
                    if (bestOppMoveDiff > bestMoveDiff2)
                    {
                        ...
                        bestResponseToOppBestMove = bestNextMove_;
                    }
                ...
                if (bestOppMoveDiff > bestMoveDiff)
                {
                    ...
                    bestResponseToOppBestResponse = bestResponseToOppBestMove;
                }
            ...
            bestNextMove = bestResponseToOppBestResponse;
            isMovePreloaded = true;
            return move;
        }

        else
        {
            isMovePreloaded = false;
            return bestNextMove;
        }
	}
}
