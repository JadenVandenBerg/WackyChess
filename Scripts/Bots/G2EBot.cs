...
public class G2EBot : BotTemplate
{
    ...
    public NextMove nextMove()
    {
        ...
        foreach (NextMove nextMove in allMoves)
        {
            ...
            foreach (NextMove nextMoveOpp in allMovesOpp)
            {
                ...
                List<float> pointsOnBoard = G2EBot_getPointsOnBoardState(cloneState_, true);
                ...
                if (nextMoveOpp.moveType == "ability" && nextMoveOpp.ability.ability == "Spawn")
                {
                    oppPenalty += 2.5f;
                }
            ...
            float diff = bestOppMoveDiff - endPenalty;
    ...
    private static List<float> G2EBot_getPointsOnBoardState(BoardState bs, bool isKingWorthMore)
    {
