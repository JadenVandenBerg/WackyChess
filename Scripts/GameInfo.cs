...
public static class moveDefs = {
    public static readonly coords[] bishopMoves = {
        new coords(1,1),
        new coords(2,2),
        new coords(3,3),
        new coords(4,4),
    ...
    public static readonly coords[] rookMoves = {
        new coords(1,0),
        new coords(2,0),
        new coords(3,0),
        new coords(4,0),
    ...
    public static readonly coords[] kingMoves = {
        new coords(1,0),
        new coords(-1,0),
        new coords(0,1),
        new coords(0,-1),
    ...
    public static readonly coords[] knightMoves = {
        new coords(1,2),
        new coords(-1,2),
        new coords(2,1),
        new coords(-2,1),
    ...
    public static readonly coords[] queenMoves = {
        new coords(1,0),
        new coords(2,0),
        new coords(3,0),
        new coords(4,0),
    ...
    public static readonly coords[] standardCollateral = {
        new coords(0, 0),
        new coords(1, 1), 
        new coords(-1, 1),
        new coords(1, -1),
