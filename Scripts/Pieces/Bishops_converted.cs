...
/*
public class ReincarnatingBishop : Piece
{
    public bool disabled { get; set; } = false;
    public int color { get; set; } = 1; //1 White, -1 Black
    public float points { get; set; } = 6;
    ...
    public String wImage { get; set; } = "Images/Bishops/wReincarnatingBishop";
    public String bImage { get; set; } = "Images/Bishops/bReincarnatingBishop";
    public String name { get; set; } = "ReincarnatingBishop";

    public int flag { get; set; } = 0;
    public string spawnable { get; set; } = "";
    public int numSpawns { get; set; } = 0;

    public ReincarnatingBishop(int color, bool online, bool simulated)
    {
        if (online)
        {
            if (go == null) go = PhotonNetwork.Instantiate("Empty", new Vector2(0, 0), Quaternion.identity);
...
*/
public class ShortBishop : Piece
{
    public bool disabled { get; set; } = false;
    public int color { get; set; } = 1; //1 White, -1 Black
    ...
    public coords[] moves { get; set; } = { };
    public coords[] oneTimeMoves { get; set; } = { };
    public coords[] moveAndAttacks { get; set; } = { new coords(1, 1), new coords(2, 2), new coords(3, 3), new coords(4, 4), new coords(-1, 1), new coords(-2, 2), new coords(-3, 3), new coords(-4, 4), new coords(1, -1), new coords(2, -2), new coords(3, -3), new coords(4, -4), new coords(-1, -1), new coords(-2, -2), new coords(-3, -3), new coords(-4, -4) };
    public coords[] oneTimeMoveAndAttacks { get; set; } = { };
    public coords[] murderousAttacks { get; set; } = { };
    public bool condition { get; set; } = false;
    public coords[] conditionalAttacks { get; set; } = { };
    ...
    public String wImage { get; set; } = "Images/Bishops/wShortBishop";
    public String bImage { get; set; } = "Images/Bishops/bShortBishop";
    public String name { get; set; } = "ShortBishop";

    public int flag { get; set; } = 0;
    public string spawnable { get; set; } = "";
    public int numSpawns { get; set; } = 0;

    public ShortBishop(int color, bool online, bool simulated)
    {
        if (online)
        {
            if (go == null) go = PhotonNetwork.Instantiate("Empty", new Vector2(0, 0), Quaternion.identity);
