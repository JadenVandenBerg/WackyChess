...
/*
public class ReincarnatingQueen : Piece
{
    public bool disabled { get; set; } = false;
    public int color { get; set; } = 1; //1 White, -1 Black
    ...
    public String wImage { get; set; } = "Images/Queens/wReincarnatingQueen";
    public String bImage { get; set; } = "Images/Queens/bReincarnatingQueen";
    public String name { get; set; } = "ReincarnatingQueen";

    public int flag { get; set; } = 0;
    public string spawnable { get; set; } = "";
    public int numSpawns { get; set; } = 0;

    public ReincarnatingQueen(int color, bool online, bool simulated)
    {
        if (online)
        {
            if (go == null) go = PhotonNetwork.Instantiate("Empty", new Vector2(0, 0), Quaternion.identity);
...
public class ShortQueen : Piece
{
    ...
    public coords[] moves { get; set; } = { };
    public coords[] oneTimeMoves { get; set; } = { };
    public coords[] moveAndAttacks { get; set; } = { new coords(1, 1), new coords(2, 2), new coords(3, 3), new coords(4, 4), new coords(-1, 1), new coords(-2, 2), new coords(-3, 3), new coords(-4, 4), new coords(1, -1), new coords(2, -2), new coords(3, -3), new coords(4, -4), new coords(-1, -1), new coords(-2, -2), new coords(-3, -3), new coords(-4, -4), new coords(0, 1), new coords(0, 2), new coords(0, 3), new coords(0, 4), new coords(1, 0), new coords(2, 0), new coords(3, 0), new coords(4, 0), new coords(0, -1), new coords(0, -2), new coords(0, -3), new coords(0, -4), new coords(-1, 0), new coords(-2, 0), new coords(-3, 0), new coords(-4, 0) };
    public coords[] oneTimeMoveAndAttacks { get; set; } = { };
    public coords[] murderousAttacks { get; set; } = { };
    public bool condition { get; set; } = false;
    public coords[] conditionalAttacks { get; set; } = { };
    ...
    public String wImage { get; set; } = "Images/Queens/wShortQueen";
    public String bImage { get; set; } = "Images/Queens/bShortQueen";
    public String name { get; set; } = "ShortQueen";

    public int flag { get; set; } = 0;
    public string spawnable { get; set; } = "";
    public int numSpawns { get; set; } = 0;

    public ShortQueen(int color, bool online, bool simulated)
    {
        if (online)
        {
            if (go == null) go = PhotonNetwork.Instantiate("Empty", new Vector2(0, 0), Quaternion.identity);
